...
mods.jei.JEI.removeAndHide(<botania:manasteelboots>);
	...
	recipes.addShaped(<botania:manabomb>,
	[[<ore:livingwood>,<minecraft:tnt>,<ore:livingwood>],
	[<minecraft:tnt>,<astralsorcery:itemcelestialcrystal>,<minecraft:tnt>],
	[<ore:livingwood>,<minecraft:tnt>,<ore:livingwood>]]);
	...
	[[null,null,null],
	[<ore:plateStellarAlloy>,<botania:spreader:2>,<ore:plateStellarAlloy>],
	[null,null,null]]);

	#duplicate petals
chemical_bath.recipeBuilder()
	.inputs(<ore:botaniaPetals>)
	.fluidInputs([<liquid:mana_fluid> * 5])
	.outputs(<botania:petal>*2)
    .duration(600)
    .EUt(12)
    .buildAndRegister();	
	...
	#tiny mana steel dust
	furnace.addRecipe(<botania:manaresource:17>, <gregtech:meta_item_1:805>);
...
#Feathers
mods.botania.ManaInfusion.addInfusion(<minecraft:feather>, <minecraft:egg>, 500);
...
mods.botania.ManaInfusion.addAlchemy(manaPowder, <contenttweaker:mana_enriched_egg>, 5000);
