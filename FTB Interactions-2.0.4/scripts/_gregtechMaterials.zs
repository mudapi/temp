...
materialEnderium.setCableProperties(2048, 4, 0);
...
materialStellar.setCableProperties(8192, 4, 0);
...
materialTerrasteel.setCableProperties(32768, 4, 0);
	...
	#Bluesteel
val materialBluesteel = MaterialRegistry.createIngotMaterial(828, "bluesteel", 0x263ADC, "SHINY", 6, null, 12.0f, 6, 2800);
materialBluesteel.addToolEnchantment(<enchantment:minecraft:efficiency> * 1); 
materialBluesteel.addFlags(["GENERATE_PLATE", "GENERATE_ROD", "GENERATE_BOLT_SCREW", "GENERATE_GEAR"]);
materialBluesteel.setCableProperties(32, 4, 0);
...
rawlatticite.setFluidTemperature(1500);
	...
	#Infused Fuel
val naquadriaticFuel = MaterialRegistry.createFluidMaterial(827, "naquadriaticfuel", 0x24022b, "FLUID");
naquadriaticFuel.addFlags(["GENERATE_FLUID_BLOCK"]);
naquadriaticFuel.setFluidTemperature(3000);
