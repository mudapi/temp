<contenttweaker:raw_silverfish_meat>.addTooltip("Smells like death");
<contenttweaker:cooked_silverfish_meat>.addTooltip("Gives Haste I");

<contenttweaker:cooked_spider_leg>.addTooltip("Gives Speed I");
<contenttweaker:raw_spider_leg>.addTooltip("Still twitching");
