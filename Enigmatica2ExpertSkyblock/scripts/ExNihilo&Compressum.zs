...
# Baits
	recipes.addShapeless("Llama Bait",<excompressum:bait:11>,[<minecraft:wheat>,<ore:listAllsugar>]);
	recipes.addShapeless("Polar Bear Bait",<excompressum:bait:10>,[<minecraft:snowball>,<ore:listAllfishraw>]);
	recipes.addShapeless("Parrot Bait",<excompressum:bait:12>,[<ore:dyeRed>,<ore:dyeGreen>]);
...
# Ex Nihilo Dusts
	...
	rh(<exnihilocreatio:item_ore_ardite:2>);
	rh(<exnihilocreatio:item_ore_cobalt:2>);
