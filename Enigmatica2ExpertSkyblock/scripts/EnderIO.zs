...
# Enchanter
	...
	[<rftools:infused_diamond>, <thermalexpansion:machine:13>.onlyWithTag({RSControl: 0 as byte, Facing: 3 as byte, Energy: 0, SideCache: [1, 1, 2, 2, 2, 2] as byte[] as byte[], Level: 0 as byte}), <rftools:infused_diamond>], 
