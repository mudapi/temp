...
mods.extendedcrafting.TableCrafting.addShaped(0, <projecte:item.pe_time_watch>, [
	[<minecraft:clock>, <tconstruct:large_plate>.withTag({Material:"obsidiorite"}), <tconstruct:large_plate>.withTag({Material:"solarium"}), <tconstruct:large_plate>.withTag({Material:"obsidiorite"}), <minecraft:clock>], 
	[<tconstruct:large_plate>.withTag({Material:"obsidiorite"}), <tconstruct:large_plate>.withTag({Material:"solarium"}), <tconstruct:large_plate>.withTag({Material:"redmatter"}), <tconstruct:large_plate>.withTag({Material:"solarium"}), <tconstruct:large_plate>.withTag({Material:"obsidiorite"})], 
	[<tconstruct:large_plate>.withTag({Material:"solarium"}), <tconstruct:large_plate>.withTag({Material:"redmatter"}), <tconstruct:large_plate>.withTag({Material:"redmatter"}), <tconstruct:large_plate>.withTag({Material:"redmatter"}), <tconstruct:large_plate>.withTag({Material:"solarium"})], 
	[<tconstruct:large_plate>.withTag({Material:"obsidiorite"}), <tconstruct:large_plate>.withTag({Material:"solarium"}), <tconstruct:large_plate>.withTag({Material:"redmatter"}), <tconstruct:large_plate>.withTag({Material:"solarium"}), <tconstruct:large_plate>.withTag({Material:"obsidiorite"})], 
	[<minecraft:clock>, <tconstruct:large_plate>.withTag({Material:"obsidiorite"}), <tconstruct:large_plate>.withTag({Material:"solarium"}), <tconstruct:large_plate>.withTag({Material:"obsidiorite"}), <minecraft:clock>]
]);
